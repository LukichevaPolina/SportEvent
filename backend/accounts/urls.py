...
from .views import VerifyEmail, LoginAPIView, PasswordTokenCheckAPIView, UploadPhoto, RegisterView, RequestPassworResetEmail, SetNewPasswordAPIView, ChangeAccountInformation, GetUsersView, GetUserByIdView
