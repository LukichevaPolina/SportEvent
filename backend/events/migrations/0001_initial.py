    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2022, 4, 12)), django.core.validators.MaxValueValidator(datetime.date(2022, 5, 12))])),
